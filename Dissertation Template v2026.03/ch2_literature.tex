...
% -----------------------------------------------------------------------------------
\section{Generative AI and Productivity: From Task Performance to Organizational Outcomes}
\label{sec:Generative AI and Productivity: From Task Performance to Organizational Outcomes}
...
This difference is supported by firm-level evidence. According to \textcite{Babina2024}, adoption of AI has a positive relationship with both firm growth and innovation, and the relationship is more pronounced for firms equipped with complementary capabilities. The association is believed to be realized mainly via product innovation, as opposed to labor replacement effects, thus suggesting that AI assists in value creation through product innovation rather than reducing costs.
...
Firm-level financial and innovation results refer to the overall organizational benefits that are realized when there is an increase in productivity and workflow improvements as well as at the financial level. At the firm level, the organization seeks to determine whether the implementation of AI technologies results in benefits such as improved operational efficiency, lower development costs, faster time-to-market, or new forms of digital products/services, among others. Empirical studies conducted to determine the impact of AI technology adoption by organizations revealed that artificial intelligence technologies could drive organizational growth through innovation and improved productivity \autocite{Babina2024}. Therefore, it is critical to understand the role of organizational culture and leadership in the successful implementation of AI coding assistants, given the fact that the achievement of a financial return is dependent on the organization’s ability to adopt the new technology.
...
\end{itemize}
Organizational adoption quality relates to the extent and quality of the incorporation of AI tools in organizational routines and practices. It should be noted that the mere incorporation of AI coding assistants in the development environment does not guarantee the quality and extent of the usage of such tools in organizational settings. Organizational adoption quality of AI tools can be regarded as high if developers effectively incorporate AI tools in coding activities, testing activities, and collaborative activities such as code reviews. Empirical studies of the organizational adoption of AI tools suggest that the organizational benefits of AI technologies depend significantly on the extent and quality of the incorporation of these tools in organizational routines and activities and the extent of organizational learning \autocite{An2024}. Therefore, organizational adoption quality can be regarded as a critical factor in determining the organizational value of AI coding assistants.

\begin{itemize}
	\item \textbf{Governance Costs} 
\end{itemize}
Governance costs refer to the costs associated with managing and regulating the usage of artificial intelligence (AI) technologies in an organization. The usage of AI coding assistants poses various governance challenges to an organization in terms of data privacy, intellectual property rights, software quality assurance, and compliance with organizational policies. According to various scholarly research on the governance of AI, effective governance mechanisms are necessary to ensure that the usage of AI coding assistants is within acceptable risk parameters and complies with organizational standards \autocite{Schneider2023}. However, implementing governance mechanisms requires time and administrative costs, which are additional costs to consider when evaluating the return on investment in artificial intelligence.

\begin{itemize}
	\item \textbf{Risks Involved} 
\end{itemize}
The risk exposure adjustments relate to how potential risks associated with the adoption of AI are considered when evaluating financial returns. There is a potential risk of incorporating coding assistants that may lead to software defects, security breaches, or copyright issues. The adoption of AI is likely to increase software defects, security breaches, or copyright issues. This implies that an organization is likely to incur additional costs when risks associated with AI adoption are realized. According to an empirical study on organizational adoption of AI, technological advantages need to be balanced with risk management and governance to ensure sustainable value creation \autocite{Schneider2023}. he necessity of adapting the return on investments formula to account for risks involved in the adoption of artificial intelligence technology means that one should be cautious and avoid likely exaggeration of potential benefits.

In the field of research on AI-coded assistants, there is no unified model. This paper aims to minimize the gap in knowledge.

\section {Organizational Culture as a Mediator of AI Value Realization.}
\label{sec:Organizational Culture as a Mediator of AI Value Realization}
...
The leadership function assumes critical importance in ensuring that AI adoption is in sync with business goals and risk management processes. The body of research on AI governance has identified three interrelated but distinct layers of AI governance (1) data governance, (2) model governance, and (3) organizational/system governance \autocite{Schneider2023}. However, leadership ensures that AI governance structures are embedded within the organization rather than being adopted in an informal and ad hoc manner.
...
Another important role of a leader involves resource allocation, which includes the provisioning of the financial, technical, and human resources needed to support the effective integration of the various AI tools into the organizational processes. The effective adoption of AI tools in the organizational processes is more than just the acquisition of the various AI tools. For instance, empirical research on the economic impact of the adoption of AI tools has shown that the ability of the organization to invest in the acquisition of various capabilities would have a positive impact on the ability of the organization to realize productivity improvements from the various AI tools \autocite{Babina2024}. In the case of software engineering, the allocation of resources may limit the ability of the developer to experiment with the various coding assistants, thus limiting the ability to realize the various learning processes.

\subsection {Metrics alignment.}
\label{sec:Metrics alignment}
The role of leadership in achieving the alignment of metrics, which means the congruence of the organizations performance metrics and expected results of employing AI tools, cannot be overestimated. AI technologies, including coding assistants influence many aspects of software development productivity such as speed of software development, quality of code produced, collaboration, and defect reduction. The research in productivity results from generative AI technologies indicates that, while these tools are helpful in speeding up the accomplishment of tasks, the outcomes depend heavily on the assessment of the output and its integration in the organizational activities \autocite{Noy2023}. In situations where speed of results is set as a goal and sufficient quality is not achieved, the application of these technologies sometimes leads to an increase in the amount of technical debt. However, metrics that balance speed with quality outcomes allow an organization to leverage the performance outcomes of generative AI coding assistants to achieve operational performance.

\subsection {Policy enforcement.}
\label{sec:Policy enforcement}
Another key responsibility of leaders in this case is policy enforcement, which is described as the development and implementation of governance systems that guide the usage of AI coding assistants in the workflow of an organization. The coding assistants pose new challenges in terms of governance, including intellectual property rights and verification of the source of the code, and managing risks to security. The research on AI governance shows that when an organization has a system of governance in place, it is in a better position to manage technological risks and sustain performance improvements with the adoption of AI coding assistants \autocite{Schneider2023}. This reduces uncertainty among developers and provides guidance on the usage of AI coding assistants.
...
The adoption of artificial intelligence (AI) occurs in an institutional context characterized by defined differences in capabilities and limited availability of resources in emerging markets. In South Africa, for example, members of the South African software engineering sector agree on the fact that the competition and changes in labor conditions resulting from AI adoption are favorable \autocite{Poisat2024}. 

The software engineering sector in South Africa includes many big companies that use complex systems and need digital transformation. Nevertheless, the governing authority and specialization of the workforce differ in many organizations.
This highlights the importance of leadership and organizational culture in the achievement of AI benefits. In addition, on resource-scarce environments, justifying the return on investment (ROI) of AI implementation becomes essential. In this case, misalignment in the organization increases the risk of implementation.
...
\end{itemize}
Organizational culture and leadership have been recognized as key factors in the achievement of successful technology implementation outcomes. The empirical findings have suggested that the organizational culture for digitalisation can strengthen the impact of the capabilities of artificial intelligence on innovation and performance \autocite{An2024}. Leadership has been observed as the key factor in the development of the governance structure for the implementation of responsible AI in the organizational environment \autocite{Schneider2023}. However, the importance of organizational culture and leadership has been recognized in the literature while studying these factors in isolation for the achievement of technological performance outcomes. Only limited empirical research has been conducted on the development of the organizational culture and leadership factors within the financial framework for the assessment of the return on investment in AI technologies.

\begin{itemize}
	\item \textbf{Insufficient measurement of the operation at team level} 
\end{itemize}
The available literature on AI-driven productivity tends to focus more on individual performance measures and not team-level measures to ensure operational effectiveness. However, it is to be noted that software development is a team-based activity in which developers interact with each other through various processes. Studies that have been conducted to understand the role of AI coding assistants have shown that these tools are used at various stages of the software development lifecycle, though there is a significant variation in their usage \autocite{Sergeyuk2025}. It is not clear how these tools influence the productivity and quality of software engineering teams without analyzing team-level measures.
...
This chapter reviewed evidence on the productivity and organizational value of generative AI and AI coding assistants. The literature indicates that while AI coding tools can boost productivity at an operational level, it does not imply that these productivity improvements will result in a positive return on investment for organizations. Achieving the desired value realization will depend on the method of artificial intelligence implementation in the workflow and the accompanying organizational capabilities.

The review found that leadership, organizational culture, governance, and the quality of implementation are critical factors in securing the conversion of productivity enhancements into organizational benefits. Critically, limitations of current ROI metrics were identified, given that they usually do not pay enough attention to outcomes related to workflow and organization level.

Four critical gaps were uncovered, namely insufficient research into financial ROI of AI coding assistants, poor application of leadership and organizational culture in ROI models, lack of team level evidence, and absence of empirical studies from South Africa. This study seek to address these gaps by examining how IT leadership and organizational culture relate to AI coding assistant assimilation and ROI within South African software engineering teams.